...
export default function Hero({ searchQuery, onSearchChange }: HeroProps) {
  return (
    <section className="relative h-[80vh] flex flex-col items-center justify-center px-8 overflow-hidden">
      {/* Animated Background */}
      ...
      >
        <motion.h1 
          ...
          className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight mb-6 pb-4 bg-gradient-to-b from-white to-white/60 bg-clip-text text-transparent text-balance leading-[1.1]"
        >
        ...
        >
          The curated index for Waterloo and Laurier student life.
        </motion.p>
        ...
        <motion.div
          ...
          className="relative max-w-2xl mx-auto group px-4"
        >
